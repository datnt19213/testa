            ...
            <div id="header-infor">
                <p>
                    <pre class="account-show">
                        <a href="?page=login"><p style="color: white; font-family:'Times New Roman', Times, serif; font-size:20px; font-weight:bold;"></p><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-shield-lock-fill" viewBox="0 0 16 16">
                        <path fill-rule="evenodd" d="M8 0c-.69 0-1.843.265-2.928.56-1.11.3-2.229.655-2.887.87a1.54 1.54 0 0 0-1.044 1.262c-.596 4.477.787 7.795 2.465 9.99a11.777 11.777 0 0 0 2.517 2.453c.386.273.744.482 1.048.625.28.132.581.24.829.24s.548-.108.829-.24a7.159 7.159 0 0 0 1.048-.625 11.775 11.775 0 0 0 2.517-2.453c1.678-2.195 3.061-5.513 2.465-9.99a1.541 1.541 0 0 0-1.044-1.263 62.467 62.467 0 0 0-2.887-.87C9.843.266 8.69 0 8 0zm0 5a1.5 1.5 0 0 1 .5 2.915l.385 1.99a.5.5 0 0 1-.491.595h-.788a.5.5 0 0 1-.49-.595l.384-1.99A1.5 1.5 0 0 1 8 5z"/>
                        </svg></a>&nbsp;&nbsp;&nbsp;|<b id="account"><?php if(isset($_SESSION['us'])&&$_SESSION['us']!=""){echo "Welcome ".$_SESSION['us'];}elseif(isset($_SESSION['ad'])&&$_SESSION['ad']!=""){echo $_SESSION['ad'];}else{echo "";}?></b>
                    </pre
                </p>
                <a href="Admin_Page.php" id="header-Namepage"><h1 id="header-Namepage"><img src="images/IT_Logo.png" id="logo"/>Information Technology</h1></a>
            </div>
        </div>
        <marquee style="background-image: linear-gradient(lightblue, white, lightblue); color: black; font-family:'Times New Roman', Times, serif; font-weight:bold; font-size:20px;">
            Welcome to the world of the electronic and technology devices - Wish you have a good experiences at ours store
        </marquee>
                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item" id="hover">
                            <a class="nav-link active" aria-current="page" id="hover" href="Admin_Page.php">Home</a>
                        </li>
                        <li class="nav-item" id="hover">
                    ...
                    ?>
                        <li class="nav-item" id="hover" id="adclick">
                            <a class="nav-link active" aria-current="page" id="hover" href="?page=administrator">Administrator</a>
                        </li>
                        <li class="nav-item" id="hover" id="adclick">
                            <a class="nav-link active" aria-current="page" id="hover" href="Admin_Page.php"><?php session_destroy(); ?>Logout</a>
                        </li>
                    <?php
                        }
                        elseif(isset($_SESSION['us']) && $_SESSION['us'] !="")
                        {
                    ?>
                        <li class="nav-item" id="hover" id="adclick" style="display:none;">
                            <a class="nav-link active" aria-current="page" id="hover" href="?page=administrator">Administrator</a>
                        </li>
                        <li class="nav-item" id="hover" id="adclick">
                            <a class="nav-link active" aria-current="page" id="hover" href="Admin_Page.php"><?php session_destroy(); ?>Logout</a>
                    ...
                    ?>  
                        ...
                        <li class="nav-item" id="hover" id="adclick">
                            <a class="nav-link active" aria-current="page" id="hover" href="?page=login">Login</a>
                        </li>
                    <?php
                        }
                    ?>
        ...
        <div id="footer">
            <footer>
                ...
                <table>
                    <td id="footer-infor">
                        <ul id="contact-infor">
                            <li><a href="https://mail.google.com/mail/u/2/#inbox">Email:datntgcc19213@fpt.edu.vn</a></li>
